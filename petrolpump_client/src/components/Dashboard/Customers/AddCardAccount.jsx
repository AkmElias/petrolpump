...
import { ADD_CARD_ACCOUNT_MUTATION } from '../../../gql/Mutation';

const AddCardAccount = () => {
  const { register, handleSubmit, reset, errors } = useForm();
  const [createCardAccount] = useMutation(ADD_CARD_ACCOUNT_MUTATION);
  ...
  return (
    <div className='controlled-form common-border-pad common-bg'>
      <h1>কার্ড একাউন্ট অ্যাড করুন</h1>
